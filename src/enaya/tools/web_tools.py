...
WEB_SEARCH_SCHEMA = {
    ...
    "function": {
        "name": "web_search",
        "description": (
            "Search the web for information. Returns up to 10 results with "
...
WEB_EXTRACT_SCHEMA = {
    ...
    "function": {
        "name": "web_extract",
        "description": (
            "Extract content from web page URLs. Returns clean page content "
            "in markdown/text. Also works with PDF URLs."
        ),
        "parameters": {
            "type": "object",
            "properties": {
